        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            while (running) {
                ...
                try (Socket clientSocket = connectionAcceptor.accept(serverSocket)) {
                    ...
                    // Poll loop tick to keep single-threaded server responsive to local commands.
                } catch (Exception e) {
            ...
            try {
                ...
                LOGGER.info("Collection saved on server shutdown.");
            } catch (IOException e) {
                LOGGER.log(Level.SEVERE, "Failed to save collection on shutdown.", e);
            }
        }
    }
}
